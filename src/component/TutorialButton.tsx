...
import discordUrl from './img/discord-text-url.jpg';
import copyCss from './img/copy-text-css.jpg';
import obsCss from './img/obs-css.png';
import obsComplete from './img/obs-text-complete.jpg';
    ...
    <>
      ...
      <Dialog maxWidth="md" open={open} onClose={() => setOpen(false)}>
        ...
        <DialogContent>
          ...
          <h2>4. チャットウィジェットのURLを取得</h2>
          <p>「Install for OBS」をクリックし、「CHAT WIDGET」のタブを選択</p>
          <p>「Server」と「Text Channel」からテキストチャンネルを選択</p>
          <p>右下に表示されるURLをコピー</p>
          ...
          <h2>8. 作成完了</h2>
          <p>ダイアログをOKで閉じて完了です<br />OBSにテキストチャットへの投稿が表示されます</p>
          <Box sx={{ textAlign: 'center' }}>
